                ...
                <div className={`flex flex-wrap justify-center md:justify-start gap-1 md:gap-1 w-full pl-4 py-4
                    ...
                    {associations.map((partner, index) => (
                        <div 
                            ...
                            className="relative w-40 h-48 flex items-center justify-center transition-all duration-300 ease-out hover:scale-110 hover:drop-shadow-xl hover:z-10"
                        >
                    ...
                    <div className="relative w-40 h-48 hidden md:flex items-center justify-center opacity-40 pointer-events-none transition-all duration-300 ease-out hover:scale-110 hover:drop-shadow-xl hover:z-10">
                        <Image
                            src={HexagonPurple}
                            alt="Hexagon"
                            width={150}
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-12">
                ...
                <div className={`flex flex-wrap justify-center md:justify-start gap-1 md:gap-1 w-full pl-4 py-4
                    ...
                    {clientele.map((client, index) => (
                        <div 
                            key={index}
                            className="relative w-32 h-40 flex items-center justify-center transition-all duration-300 ease-out hover:scale-110 hover:drop-shadow-xl hover:z-10"
                        >
                            <div className="relative w-full h-full">
                                <Image 
                                    src={client.logo} 
                    ...
                    <div className="relative w-28 h-32 hidden md:flex items-center justify-center opacity-40 pointer-events-none transition-all duration-300 ease-out hover:scale-110 hover:drop-shadow-xl hover:z-10">
                        <Image
                            src={HexagonBlue}
                            alt="Hexagon"
                            width={150}
