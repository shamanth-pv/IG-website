...
import hands from '@/assets/BG Images/OurServices.png'
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                    {services.map((service, index) => (
                        <div
                            key={index}
                            className={`
                                group relative bg-white/40 backdrop-blur-md border border-white/50 rounded-3xl 
                                shadow-xl transition-all duration-[1200ms] ease-[cubic-bezier(.22,.68,.32,1.01)]
                                flex flex-col items-center justify-center 
                                
                                // Mobile: p-6, min-h-[200px] | Desktop: p-8, min-h-[250px]
                                p-6 min-h-[220px] 
                                md:p-8 md:min-h-[250px]
